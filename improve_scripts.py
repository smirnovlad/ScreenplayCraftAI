...
for person_id in range(1, 14):
    ...
    with open(f"mistral_results/{person_id}_script.txt", "r", encoding="utf-8") as text_file:
    ...
    agent.reset_context()
    with open(f"improved_mistral_results/{person_id}_script.txt", "w", encoding="utf-8") as text_file:
